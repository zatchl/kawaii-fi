...
{
	appendRow(
	        supportable_field_row("20/40 BSS Coexistence Management",
	...
	appendRow(supportable_field_row("PSMP Capability", extended_capabilities.psmp_capability()));
	...
	appendRow(
	        supportable_field_row("Location Tracking", extended_capabilities.location_tracking()));

	appendRow(supportable_field_row("FMS", extended_capabilities.fms()));

	appendRow(
	        supportable_field_row("Proxy ARP Service", extended_capabilities.proxy_arp_service()));
	...
	appendRow(supportable_field_row("AC Station Count", extended_capabilities.ac_station_count()));
	...
	appendRow(
	        supportable_field_row("TDLS Peer PSM", extended_capabilities.tdls_peer_psm_support()));
	...
	appendRow(supportable_field_row("MSGCF Capability", extended_capabilities.msgcf_capability()));

	appendRow(supportable_field_row("TDLS Support", extended_capabilities.tdls_support()));

	appendRow(supportable_field_row("TDLS Prohibited", extended_capabilities.tdls_prohibited()));
	...
	appendRow(
	        supportable_field_row("U-APSD Coexistence", extended_capabilities.uapsd_coexistence()));

	appendRow(supportable_field_row("WNM Notification", extended_capabilities.wnm_notification()));
